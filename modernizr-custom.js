...
! function (e, n, s) {
	...
	function o() {
		...
		for (var c in l)
			if (l.hasOwnProperty(c)) {
				...
				for (o = a(n.fn, "function") ? n.fn() : n.fn, t = 0; t < e.length; t++) i = e[t], f = i.split("."), 1 === f.length ? Modernizr[f[0]] = o : (!Modernizr[f[0]] || Modernizr[f[0]] instanceof Boolean || (Modernizr[f[0]] = new Boolean(Modernizr[f[0]])), Modernizr[f[0]][f[1]] = o), r.push((o ? "" : "no-") + f.join("-"))
			}
	}
	...
	Modernizr.addTest("progressbar", i("progress").max !== s), Modernizr.addTest("meter", i("meter").max !== s), Modernizr.addTest("geolocation", "geolocation" in navigator), o(), t(r), delete f.addTest, delete f.addAsyncTest;
